...
public final class MensagensErroConstantes {
    ...
    public static final String CARTAO_ERRO_AO_ATIVAR = "[CART003] Erro ao ativar o cartão.";
    public static final String CARTAO_ERRO_AO_ATUALIZAR_CARTAO_ORIGINAL = "[CART004] Erro ao atualizar o cartão original.";
    public static final String CARTAO_ERRO_AO_SALVAR_SEGUNDA_VIA = "[CART010] Erro ao salvar a segunda via do cartão.";
